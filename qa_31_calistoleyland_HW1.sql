/*SQL_HW_1
Создать .sql файл в котором под каждой командой напишите sql запрос который выполнит команду. Работа с таблицей students.
...
-- 5. Вывести только email пользователей
 ...
 --17. Вывести пользователя у которых id равен 110 (Ответ будет пустой, так как нет такого id.)
